...
def drawgates(lst):
    for i in range(len(lst)):
        ...
        for o in range(lst[i].innum):
            pg.draw.circle(screen, ((int(lst[i].instate[o])*255),0,0), (x, (30*o)+y+15 ),15)
        for o in range(lst[i].outnum):
            pg.draw.circle(screen, ((int(lst[i].outstate[o])*255),0,0), (x+rw, (30*o)+y+15 ),15)
...
def drawinouts(lst):
    for i in lst:
        pg.draw.circle(screen, (i.state*255,0,0), (i.x,i.y), 15)
    ...
    for ios in inouts:
        ...
        if d < 15 and m1 == 1 and m1p == 0:
            ...
            if ios.mode == 0:
                ...
                wirelst.append(i)
            wireing = True
        if d < 15 and m3 == 1 and m3p == 0:
            ios.state = int(((ios.state-0.5)*-1)+0.5)
        if saving == True:
            if ios.mode == 0:
